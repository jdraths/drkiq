...
module Drkiq
  class Application < Rails::Application
    ...
    # # set up rails to read local_env.yml for ENVIRONMENT VARIABLES
    # normally would do this, but maybe not needed with DOCKER since docker file references the file
